...
public class ModeloTablaBoleto extends AbstractTableModel {
    ...
    private DynamicList<Pasajero> listaPasajero;

    public DynamicList<Pasajero> getListaPasajero() {
        return listaPasajero;
    }

    public void setListaPasajero(DynamicList<Pasajero> listaPasajero) {
        this.listaPasajero = listaPasajero;
    }
    
    @Override
    public int getRowCount() {
        return listaPasajero.getLength();
    }
